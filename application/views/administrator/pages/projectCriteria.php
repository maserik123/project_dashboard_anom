<script>
    ...
    $(document).ready(function() {
        table = $('#projectMaster').DataTable({
            ...
            "dataType": 'JSON',
            "ajax": {
                "url": "<?php echo site_url('administrator/projectCriteria/getAllData') ?>",
                "type": "POST",
                "data": {
    ...
    function updateData(id) {
        ...
        //Load data dari ajax
        $.ajax({
            url: "<?php echo base_url('administrator/projectCriteria/getById/'); ?>" + id,
            type: "GET",
            dataType: "JSON",
    ...
    function deleteData(id) {
        swal({
            ...
            if (result == true) {
                $.ajax({
                    url: "<?php echo site_url('administrator/projectCriteria/delete'); ?>/" + id,
                    type: "POST",
                    data: {
                        '<?php echo $this->security->get_csrf_token_name(); ?>': '<?php echo $this->security->get_csrf_hash(); ?>'
                    },
    ...
    function save() {
        ...
        if (save_method_role == 'add') {
            url = '<?php echo base_url() ?>administrator/projectCriteria/insert';
        } else {
            url = '<?php echo base_url() ?>administrator/projectCriteria/update';
        }
