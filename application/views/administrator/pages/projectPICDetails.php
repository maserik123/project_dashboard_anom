<script>
    ...
    $(document).ready(function() {
        table = $('#projectMaster').DataTable({
            ...
            "dataType": 'JSON',
            "ajax": {
                "url": "<?php echo site_url('administrator/projectPICDetails/getAllData') ?>",
                "type": "POST",
                "data": {
    ...
    function deleteData(id) {
        swal({
            ...
            if (result == true) {
                $.ajax({
                    url: "<?php echo site_url('administrator/projectPICDetails/delete'); ?>/" + id,
                    type: "POST",
                    data: {
                        '<?php echo $this->security->get_csrf_token_name(); ?>': '<?php echo $this->security->get_csrf_hash(); ?>'
                    },
    ...
    function save() {
        ...
        if (save_method_role == 'add') {
            url = '<?php echo base_url() ?>administrator/projectPICDetails/insert';
        } else {
            url = '<?php echo base_url() ?>administrator/projectPICDetails/update';
        }
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">PIC Project Details</h3>
        ...
        <div class="modal-content">
            ...
            <form class="form-horizontal" id="formMasterProject" action="" method="POST">
                <div class="modal-body">
                    <input type="hidden" name='pic_project_dtl_id' value="" id='pic_project_dtl_id'>
                    <div class="item form-group">
                        <label class="control-label col-md-12 col-sm-3 col-xs-12">PIC Project Name <span class="required">*</span>
                        </label>
