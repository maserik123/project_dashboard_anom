...
class Model_ProjectHeader extends CI_Model
{
    ...
    function getAllData()
    {
        $this->datatables->select('project_m_hdr_id, project_name, pic_project_name, criteria_project_name, criteria_color, status_color, color_update_status, start_date, end_date, duration, capex_budget, capex_realization,, contract_value, revenue_target, revenue_realization, status_name, progress_project, progress_fisik, progress_kajian, mitigation, checklist, foto, update_status');
